...
private:
    ...
    std::vector<Animal> m_wolves;
    std::vector<Animal> m_deer;
...
template <size_t N>
void Spirit::update(std::vector<Entity *> &entities, std::array<Terrain, N> &terrains) {
...
template <size_t N>
void Spirit::followPlayer(std::vector<Entity*> &entities, std::array<Terrain, N> &terrains) {
...
template <size_t N>
void Spirit::updateAnimals(std::vector<Entity*> &entities, std::array<Terrain, N> &terrains) {
